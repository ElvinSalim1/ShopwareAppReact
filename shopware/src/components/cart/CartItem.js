        ...
        <div className="cart-item">
            <div className="p-2 d-flex justify-content-between align-items-center">
                <div className="d-flex align-items-center">
                    <img src={item.image} className="img-fluid image-width" style={{maxWidth: "100px"}} alt="" />
                    <div>
                        <div>
                ...
                <div>
                    <div className="btn-group btn-group-sm" role="group" aria-label="quantity">
                        ...
                        <button type="button" className="btn btn-grey px-3" onClick={cartIncrement}>+</button>
                    </div>

                    <div className="btn-group btn-group-sm">
                        <button className="btn btn-red px-3" onClick={cartDelete}><i className="fas fa-trash"></i></button>
                    </div>
                </div>
            </div>
